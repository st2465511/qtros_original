...
//    system("gnome-terminal -x bash -c 'export ROS_MASTER_URI=http://192.168.43.202:11311; export ROS_IP=192.168.43.219;:11311; export ROS_IP=192.168.43.219; roslaunch kafka_ros producer.launch'");



void MainWindow::on_pushButton_3_clicked(bool check){

    system("gnome-terminal -x bash -c 'export ROS_MASTER_URI=http://140.116.215.118:11311; export ROS_IP=172.17.0.1; roslaunch kafka_ros producer.launch'");
}
void MainWindow::on_pushButton_4_clicked(bool check){
    system("gnome-terminal -x bash -c 'export ROS_MASTER_URI=http://172.17.0.1:11311; export ROS_IP=172.17.0.1; roslaunch kafka_ros consumer.launch'");
}

void MainWindow::on_pushButton_7_clicked(bool check){
    system("gnome-terminal -x bash -c 'export ROS_MASTER_URI=http://172.17.0.1:11311; export ROS_IP=172.17.0.1; cd ~/Autoware/ros; ./run_no_roscore'");
}

void MainWindow::on_pushButton_5_clicked(bool check){
    system("gnome-terminal -x bash -c 'docker run -p 8080:8080 -d -t -v ~/mapproxy:/mapproxy danielsnider/mapproxy'");
    system("gnome-terminal -x bash -c 'export ROS_MASTER_URI=http://140.116.215.118:11311; export ROS_IP=172.17.0.1;roslaunch rviz_satellite shalun_image.launch'");
}

void MainWindow::on_pushButton_6_clicked(bool check){
    system("gnome-terminal -x bash -c 'export ROS_MASTER_URI=http://140.116.215.118:11311; export ROS_IP=172.17.0.1; roslaunch qtros rm.launch'");
}
